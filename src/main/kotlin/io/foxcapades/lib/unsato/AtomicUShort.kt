...
/**
 * An unsigned short value that may be updated atomically.
 *
 * @since 1.0.0
 * @author Elizabeth Paige Harper [https://github.com/foxcapades]
 */
data class AtomicUShort(private var actual: UByte = 0u) {
  ...
  /**
   * Adds the given value to this [AtomicUShort].
   *
  ...
  /**
   * Subtracts the given value from this [AtomicUShort].
   *
  ...
  /**
   * Divides this [AtomicUShort] by the given value.
   *
  ...
  /**
   * Multiplies this [AtomicUShort] by the given value.
   *
  ...
  override fun equals(other: Any?) =
    lock.read { if (other !is AtomicUShort) false else other.value == actual }

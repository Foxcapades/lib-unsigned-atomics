...
/**
 * An unsigned byte value that may be updated atomically.
 *
 * @since 1.0.0
 * @author Elizabeth Paige Harper [https://github.com/foxcapades]
 */
data class AtomicUByte(private var actual: UByte = 0u) {
  ...
  /**
   * Adds the given value to this [AtomicUByte].
   *
  ...
  /**
   * Subtracts the given value from this [AtomicUByte].
   *
  ...
  /**
   * Divides this [AtomicUByte] by the given value.
   *
  ...
  /**
   * Multiplies this [AtomicUByte] by the given value.
   *
  ...
  override fun equals(other: Any?) =
    lock.read { if (other !is AtomicUByte) false else other.value == actual }
